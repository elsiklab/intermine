...
/**
 * DataConverter to load Biocyc Pathways and link them to Genes
 *
 * @author Xavier Watkins
 */
public class BiocycConverter extends BioFileConverter
{
    protected static final Logger LOG = Logger.getLogger(BiocycConverter.class);
    private static final String PROP_FILE = "biocyc_config.properties";
     ...
     */
    public BiocycConverter(ItemWriter writer, Model model) {
        super(writer, model, "Biocyc", "Biocyc pathways data set");
        readConfig();
    }
     ...
     */
    public void setBiocycOrganisms(String taxonIds) {
