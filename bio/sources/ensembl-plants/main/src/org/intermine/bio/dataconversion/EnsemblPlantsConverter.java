...
public class EnsemblPlantConverter extends BioFileConverter
{
     ...
     */
    public EnsemblplantConverter(ItemWriter writer, Model model) {
     ...
     */
    public void setEnsemblplantOrganisms(String taxonIds) {
     ...
     */
    public void setEnsemblplantHomologues(String homologues) {
    ...
    public void process(Reader reader) throws Exception {
        ...
        */
        ...
        if (taxonIds.isEmpty()) {
            LOG.warn("ensemblplant.organisms property not set in project XML file, processing all data");
        }
