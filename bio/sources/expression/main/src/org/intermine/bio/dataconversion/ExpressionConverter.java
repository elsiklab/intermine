 ...
 * @author
 */
public class ExpressionConverter extends BioFileConverter
{
    //
    protected static final Logger LOG = Logger.getLogger(ExpressionConverter.class);
     ...
     */
    public ExpressionConverter(ItemWriter writer, Model model) {
